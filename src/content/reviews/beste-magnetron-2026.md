...
products:
  - name: "Panasonic NN-CS89L"
    verdict: "TODO — write verdict"
    priceRange: "EUR 350-450"
    bestFor: "Beste combi"
    rating: 4.8
    affiliateLink: "https://partner.bol.com/.../[TODO]"
...
TODO — write full Dutch review article (~1,500-2,000 words).
Structure: intro → snel advies → beste keuze per budget → detailvergelijking per product → onderhoudstips → conclusie.
See beste-airfryer-2026.md for style reference.
